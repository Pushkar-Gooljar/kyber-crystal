...
- [ ] Explain factors influencing electronegativity (nuclear charge, atomic radius, shielding).
- [ ] State & explain trends (period, group).
- [ ] Use Pauling values to predict bond type (ionic/covalent).
