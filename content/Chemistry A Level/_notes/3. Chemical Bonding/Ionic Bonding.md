...
<figure>
  <img src="https://s3.eu-west-2.amazonaws.com/elements.cognitoedu.org/7d20286f-ea7a-442d-a821-7327453c4184/potassium-fluoride-lattice-structure.png" class="custom-img" style="max-height: 200px;">
  <figcaption>3D model of potassium fluoride's giant ionic lattice structure</figcaption>
</figure>

- A giant ionic lattice is a continuous three-dimensional crystalline structure:
...
>Answer: 
>- NaCl. This is because $\ce{Na+}$ has a smaller ionic radius than $\ce{K+}$.
>- $\ce{Na+}$ approaches $\ce{Cl-}$ more closely than $\ce{K+}$ can.
>- Electrostatic forces of attraction are stronger in $\ce{NaCl}$ than in $\ce{KCl}$.
>- More thermal energy is needed to overcome some of these forces to cause melting.
